...
in the CelebA-HQ dataset using Deep 3DMM. Please follow (https://github.com/sicxu/Deep3DFaceRecon_pytorch/blob/master/data_preparation.py)
to prepare the data.
"""
...
class Options:
    def __init__(self):
        ...
        self.focal=1015.0
        self.gpu_ids='0'
        self.img_path='../datasets/CelebA/images224x224/'
        self.lms_path='../datasets/CelebA/5_landmarks224x224/'
        self.visualize_save_path='../datasets/CelebA/bfm_fitting_results/'
        self.bfm_coeffs_save_path='../datasets/CelebA/bfm_coeffs/'
        self.realigned_img_save_path='../Datasets/CelebA/img-224x224-aligned/'
